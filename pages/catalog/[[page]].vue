...
div(class="mx-4 lg:mx-0" ref="refCatalog" id="refCatalog")
  ...
  UikitTransitionScale(direction="left")
    div(v-if="!pending")
      div(v-if="0 < diamonds.data.length" class="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-12 md:gap-y-20")
      ...
      div(v-else class="flex justify-center")
        div(class="mt-16 p-8 md:p-16 bg-tf-gray-dark shadow-lg rounded-xl")
          h3 Изделий, соответствующих критериям поиска, не найдено.
